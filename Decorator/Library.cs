...
using static Decorator.RealWorld.Borrowable;
...
namespace Decorator.RealWorld
{
    ...
    internal class MainApp
    {
        ...
        private static void Main()
        {
            ...
            var bookDanificado = new Danificado(book);
            bookDanificado.RegistrarDanoItem("Quebrou");
            bookDanificado.Display();
    ...
    internal class Borrowable : Decorator
    {
        ...
        internal class Danificado : Decorator
        {
            ...
            public void RegistrarDanoItem(string name)
            {
            ...
            public override void Display()
            {
                ...
                {
                    Console.WriteLine(" Item danificado: " + danificado);
                }
            }
        }
    }
