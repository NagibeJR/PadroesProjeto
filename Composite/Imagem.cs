...
namespace Composite.RealWorld
{
    ...
    internal class MainApp
    {
        ...
        private static void Main()
        {
            ...
            var quadrado = new CompositeElement("quadrado");

            quadrado.Add(new PrimitiveElement("blue line"));
            quadrado.Add(new PrimitiveElement("pink line"));
            quadrado.Add(new PrimitiveElement("red line"));
